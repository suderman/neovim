...
-- Gitsigns keymaps
vim.keymap.set('n', '<leader>hD', function() require('gitsigns').diffthis('~') end, { desc = 'Diff project [Gitsigns]' })
...
vim.keymap.set('n', '<leader>hb', function() require('gitsigns').blame_line{ full = true } end, { desc = 'Blame line [Gitsigns]' })
